...
import (
	...
	"github.com/huayuev5/my_go_land/modules/falcon-log-agent/common/sample_log"
	...
	for _, strategy := range sts {
		if strategy.FilePath == w.FilePath && strategy.ParseSucc {
			...
			if err != nil {
				...
				if analyspoint != nil {
					dlog.Info("SSSSSSSSSSSSucesssed.")
